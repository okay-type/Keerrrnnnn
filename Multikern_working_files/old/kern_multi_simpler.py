...
class MultiKern(Subscriber):
    ...
    def buildUIbuttons(self):
        ...
        for i, font in enumerate(self.fontlist):
            ...
            ui.alt1.right = TextBox((kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt1.flipleft = TextBox(((width/2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt1.flip = TextBox(((width/2)+kbut, 0, b*2, -0), sizeStyle='mini')
            ui.alt1.flipright = TextBox(((width/2)+kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
            ...
            ui.alt2.right = TextBox((kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt2.flipleft = TextBox(((width/2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt2.flip = TextBox(((width/2)+kbut, 0, b*2, -0), sizeStyle='mini')
            ui.alt2.flipright = TextBox(((width/2)+kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
            ...
            ui.alt3.right = TextBox((kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt3.flipleft = TextBox(((width/2), 0, kbut, -0),sizeStyle='mini',)
            ui.alt3.flip = TextBox(((width/2)+kbut, 0, b*2, -0), sizeStyle='mini')
            ui.alt3.flipright = TextBox(((width/2)+kbut+(b*2), 0, kbut, -0),sizeStyle='mini',)
    ...
    def updateUIbuttons(self):
        self.updateUIbuttons1()

    @time_it
    def updateUIbuttons1(self):
        self.activeFontIndicator()
        ...
        for i, font in enumerate(self.fontlist):
            ui, ufo = self.updateUIbuttons2(i, font)
            pairsAB, pairsBA = self.updateUIbuttons3(i, font)
            self.updateUIbuttons4(ui)
            self.updateUIbuttons5(ufo, ui, pairsAB, pairsBA)

    @time_it
    def updateUIbuttons2(self, i, font):
        name = 'buttons'+str(i)
        ui = getattr(self.w.ui, name)
        ufo = font['ufo']
    ...
    @time_it
    def updateUIbuttons3(self, i, font):
        ...
        if leftBA in self.pairAliases:
            ...
            if rightBA in self.pairAliases:
                r = self.pairAliases[rightBA]
                pairsBA.append([l, r])
        return pairsAB, pairsBA

    @time_it
    def updateUIbuttons4(self, ui):
        ui.alt1.show(False)
        ui.alt2.show(False)
        ui.alt3.show(False)

    @time_it
    def updateUIbuttons5(self, ufo, ui, pairsAB, pairsBA):
        if len(pairsAB) > 0:
