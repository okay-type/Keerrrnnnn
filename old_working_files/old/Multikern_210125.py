...
class Multikern(Subscriber, WindowController):
    ...
    def build_window_lists(self, screenW, screenH):  # lists - left side 
        ...
        self.w.lists.fontlist = List(
            ...
            columnDescriptions=[
                ...
                {'title': '', 'key': 'visibile', 'cell': CheckBoxListCell(), 'width': 22},
    ...
    def fontlist_edit(self, sender):
        ...
        for fontitem in fontlist:
            ufo = fontitem['ufo']
            if fontitem['visibile'] is True and ufo in self.fonts_no_ui:
                self.fontlist_open_ufo_ui(ufo)
            if fontitem['visibile'] is False and ufo in self.fonts_ui:
    ...
    def is_this_lower(self, g):
        ...
        # what about extended lowercase? eth agrave etc?
            ...
            # use first font
            if g in self.fontlist[0]['ufo'].glyphOrder:
                uni = self.fontlist[0]['ufo'][g].unicode
                if uni is not None:
