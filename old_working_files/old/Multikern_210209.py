...
class Multikern(Subscriber, WindowController):
    ...
    def build_window_lists(self, screenW, screenH):  # lists - left side 
        ...
        self.w.lists.whichfonts = Group((line, divide-(line*3.5), column/3-line, line*4))
        ...
        self.w.lists.whichfonts_line = VerticalLine((column/3, divide-(line*3.5), line, line*4))

        # metric adjust shortcuts
        w = column/3*2-(line*2)
        metricnudge = self.w.lists.metricnudge = Group((column/3+line, divide-(line*3.5), w, line*4))
